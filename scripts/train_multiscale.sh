...
python3.11 -m training -d ../robomaster_led/robomaster_ds_training.h5 -t pose_and_led\
    -n ${RUN_NAME} --experiment-id 0\
    --device $1 -a --visible\
    --model-type multiscale_model_s
    -v ../robomaster_led/robomaster_ds_validation.h5 --epochs 100 --learning-rate 0.002
